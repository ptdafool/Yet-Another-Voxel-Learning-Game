...
public class Clouds : MonoBehaviour
{
    ...
    bool[,] cloudData; // array of bools representing where the cloud is
    ...
    private void LoadCloudData() {
        ...
        //loop color array, set bools depending on opacity of color
        ...
        for(int xIncrement = 0; xIncrement < cloudTileSize; xIncrement++) {
            for(int zIncrement = 0; zIncrement < cloudTileSize; zIncrement++) {
                ...
                if(cloudData[xVal, zVal]) {
                    ...
                    // we know what direction faces are facing, so just add them directly.
    ...
    private int CloudTileCoordFromFloat(float value) {
        ...
        float a = value / (float)cloudTexWidth; //gets position using cloudtexturewidth as units
